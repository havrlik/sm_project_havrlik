...
public class SmList_2D_long extends SmList_2D {
	
	SmList_2D_long_Partial[] listAggregated;
	
	
	public SmList_2D_long(int columnsQuantity) {
		super(columnsQuantity);
	}
	
	
	public SmList_2D_long(int columnsQuantity, SmList_Size useArraySizesModel) {
		super(columnsQuantity, useArraySizesModel);
	}
	
	
	public SmList_2D_long(int columnsQuantity, int higherMediumSizeOfList) {
		super(columnsQuantity, higherMediumSizeOfList);
	}
	
	
	//@Override
	public void addRow(long[] itemRow) {
		maxWritedRowNumber++;
	...
	//@Override
	public void addRow_shallow(long[] itemRow) {
		maxWritedRowNumber++;
	...
	//@Override
	public void addValue(int columnNumber, long value) {
		maxWritedRowNumber++;
	...
	//@Override
	public void putRow(int rowNumber, long[] itemRow) {
	...
	//@Override
	public void putRow_shallow(int rowNumber, long[] itemRow) {
		determineArrayNumberAndRowNumberInArray(rowNumber);
	...
	//@Override
	public void putValue(int rowNumber, int columnNumber, long value) {
		determineArrayNumberAndRowNumberInArray(rowNumber);
	...
	//@Override
	public long[] getRow(int rowNumber) {
	...
	//@Override
	public long[] getRow_shallow(int rowNumber) {
		if (determineArrayNumberAndRowNumberInArray_notAddingArrays(rowNumber)) {
	...
	//@Override
	public long getValue(int rowNumber, int columnNumber) {
		if (determineArrayNumberAndRowNumberInArray_notAddingArrays(rowNumber)) {
	...
	public void clearRow(int rowNumber) {
		if (determineArrayNumberAndRowNumberInArray_notAddingArrays(rowNumber)) {
			listAggregated[arrayNumber].putRow(rowNumberInArray, new long[COLUMNSQUANTITY]);
		}
	}
	...
	protected void addArrayToList() {
		if (listAggregated == null || listAggregated.length == 0) {
			...
			// New list.
			listAggregated = null;
			listAggregated = new SmList_2D_long_Partial[list_arraySizes_length];
		}
			...
			// Copy list.
			SmList_2D_long_Partial[] list_new = new SmList_2D_long_Partial[list_arraySizes_length];
			for (int i1 = 0; i1 < listAggregated.length; i1++) {
	...
	protected void addAnotherOneArrayToList() {
		...
		listAggregated[listAggregated_initializedQuantity] = new SmList_2D_long_Partial(newArrayRowQuantity, COLUMNSQUANTITY);
