...
public class SmList_1D_Gnrc<E> extends SmList_SteadyColumns {
	
	@SuppressWarnings("rawtypes")
	protected SmList_1D_Gnrc_Partial[] listAggregated;
	
	
	public SmList_1D_Gnrc() {
		super();
	...
	public SmList_1D_Gnrc(SmList_Size useArraySizesModel) {
	...
	public SmList_1D_Gnrc(int higherMediumSizeOfList) {
	...
	protected void addArrayToList() {
		if (listAggregated == null || listAggregated.length == 0) {
			...
			// New list.
			listAggregated = null;
			listAggregated = new SmList_1D_Gnrc_Partial[list_arraySizes_length];
		}
			...
			// Copy list.
			SmList_1D_Gnrc_Partial[] list_new = new SmList_1D_Gnrc_Partial[list_arraySizes_length];
			for (int i1 = 0; i1 < listAggregated.length; i1++) {
	...
	protected void addAnotherOneArrayToList() {
		...
		listAggregated[listAggregated_initializedQuantity] = new SmList_1D_Gnrc_Partial(newArrayRowQuantity);
