...
public class SmList_1D_int extends SmList_1D {
	
	protected SmList_1D_int_Partial[] listAggregated;
	
	
	public SmList_1D_int() {
		super();
	}
	
	
	public SmList_1D_int(SmList_Size useArraySizesModel) {
		super(useArraySizesModel);
	}
	
	
	public SmList_1D_int(int higherMediumSizeOfList) {
	...
	//@Override
	public void putValue(int rowNumber, int value) {
	...
	protected void addArrayToList() {
		if (listAggregated == null || listAggregated.length == 0) {
			...
			// New list.
			listAggregated = null;
			listAggregated = new SmList_1D_int_Partial[list_arraySizes_length];
		}
			...
			// Copy list.
			SmList_1D_int_Partial[] list_new = new SmList_1D_int_Partial[list_arraySizes_length];
			for (int i1 = 0; i1 < listAggregated.length; i1++) {
	...
	protected void addAnotherOneArrayToList() {
		...
		listAggregated[listAggregated_initializedQuantity] = new SmList_1D_int_Partial(newArrayRowQuantity);
	...
	// Additional methods.
	//@Override
	public boolean is_listContainsValue(int value) {
